  ...
  return (
    <div className="w-full h-64 [perspective:1000px]" onClick={() => setIsFlipped(!isFlipped)}>
      ...
      >
        ...
        {/* Back */}
        <div className="absolute w-full h-full bg-indigo-50 dark:bg-slate-800 border border-indigo-200 dark:border-slate-600 rounded-lg shadow-lg flex items-center justify-center p-6 text-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
